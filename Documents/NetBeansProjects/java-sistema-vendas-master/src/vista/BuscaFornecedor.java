...
public class BuscaFornecedor extends javax.swing.JDialog {
    ...
    private void carregarGrade() {
        try {
            UsuarioDAO fornecedorDAO = new UsuarioDAO();
            UsuarioTableModel ctm = (UsuarioTableModel) tbGrade.getModel();
