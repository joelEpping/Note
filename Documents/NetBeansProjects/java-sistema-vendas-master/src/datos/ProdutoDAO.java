...
public class ProdutoDAO implements IDAO<Produto> {
    ...
    @Override
    public void insertar(Produto produto) throws Exception {
    ...
    @Override
    public void Modificar(Produto produto) throws Exception {
        Conexion c = new Conexion();
        String sql = "UPDATE TBPRODUTO SET NOME=?, PRECOCOMPRA=?, PRECOVENDA=?,QUANTIDADEESTOQUE=? WHERE CODIGO=?";
        PreparedStatement ps = c.getConexao().prepareStatement(sql);
        ps.setString(1, produto.getNome());
        ps.setDouble(2, produto.getPrecoCompra());
        ps.setDouble(3, produto.getPrecoVenda());
    ...
    public void entradaEstoque(Conexion c, int codigo, int quantidade) throws Exception {
    ...
    public void saidaEstoque(Conexion c, int codigo, int quantidade) throws Exception {
        String sql = "UPDATE TBPRODUTO SET QUANTIDADEESTOQUE= QUANTIDADEESTOQUE  - ? WHERE CODIGO=?";
        PreparedStatement ps = c.getConexao().prepareStatement(sql);
        ps.setInt(1, quantidade);
        ps.setInt(2, codigo);
    ...
    @Override
    public void eliminar(Produto produto) throws Exception {
        Conexion c = new Conexion();
